#pragma checksum "D:\MyCode\SZCGOA.v2\OA.MVC\Views\Manage\SysRole.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "e797ff6f2515f4bfc9348bcd40d289ad7e304bbe"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"e797ff6f2515f4bfc9348bcd40d289ad7e304bbe", @"/Views/Manage/SysRole.cshtml")]
...
#nullable disable
    ...
    let myapp = new Vue({
        ...
        methods: {
            accessModal(row) {      
                console.log(row);
                this.roleAccessModel.selectRole ");
                WriteLiteral(@"= row;
                this.roleAccessModel.dialogTitle = row.rolename + ""-编辑权限"";
                GetPromise(RoleAccessAPI, { roleid: row.id }).then(data => {
                    if (data != null) {
                        myapp.$refs.tree.setCheckedKeys(data.split(','));
                    }                  
                    myapp.roleAccessModel.dialogVisible = true;
                });
                    ...
                    DeletePromise(RoleItemAPI, { id:row.id }).then(data => {
                        if (data.status) {
                            this.$message({
                                showClose: true,
       ");
                WriteLiteral(@"                         message: data.message,
                                type: 'success',
                            });
                        } else {
                            this.$message.error(data.message);
            ...
            doSubmit() {
             ...
             ");
                WriteLiteral(@"               this.$message.error(data.message);
                        }
                    });
                } else {
                    //edit
